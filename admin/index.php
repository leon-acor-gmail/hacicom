  ...
  <div class="divSmall">
    <form>
      ...
      <div class="row divMarginButton">
        <div class="col w3-center"><button id="btnLoginSmall" type="submit" class="w3-button btnColorHaCi">Entrar</button></div>
      </div>
    </form>
  </div>
  <div class="divLarge">
    <form>
      ...
      <div class="row w3-center divMarginButton">
        <div class="col"></div>
        <div class="col align-self-center"><button id="btnLoginLarge" type="submit" class="w3-button btnColorHaCi">Entrar</button></div>
        <div class="col"></div>
      </div>
    </form>
  </div>
