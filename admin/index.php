...
<div class="container txtLineHKGrotesk">
  ...
  <div class="divSmall">
    <form>
      ...
      <div class="row w3-center divMargin">
        <div class="col"></div>
        <div class="col align-self-center"><button id="btnSmallLogin" type="submit" class="btn btnColorHaCi btnLogin">Entrar</button></div>
        <div class="col"></div>
      </div>
    </form>
  </div>
  <div class="divLarge">
    <form>
      ...
      <div class="row w3-center divMargin">
        <div class="col"></div>
        <div class="col align-self-center"><button id="btnLargeLogin" type="submit" class="btn btnColorHaCi btnLogin">Entrar</button></div>
        <div class="col"></div>
      </div>
    </form>
  </div>
